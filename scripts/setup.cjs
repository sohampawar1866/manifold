...
async function generateProject() {
  ...
  copyFolderRecursiveSync(templatePath, genProjectPath)
  console.log(`${colors.green}✅ Copied source template files${colors.reset}`)

  // Generate real functions with NetworkManager singleton
  generateRealFunctions(genProjectPath)
  console.log(`${colors.green}✅ Generated NetworkManager singleton and functions${colors.reset}`)
